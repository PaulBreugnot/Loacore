...
def test_label_bigram_frequencies():
    ...
    plot_frequencies.write_frequencies(
        freq,
        file_path=os.path.join(RESULT_PATH, 'frequencies', 'bigram_label_frequencies', 'table', 'uci'))
    plot_frequencies.frequencies_bar_chart(
        freq,
        plot=False,
        save=True,
        file_path=os.path.join(RESULT_PATH, 'frequencies', 'bigram_label_frequencies', 'charts', 'uci'),
        file_name="uci_bigram_labels_frequencies.pdf",
        val_number=60)
